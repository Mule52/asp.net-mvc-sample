...
namespace Sample.Web.Controllers
{
    ...
    //    {
    //        IQueryable<Department> departments = _context.Departments.Include(d => d.Administrator);
    ...
    //                                                             +
    //                                                             _context.Instructors.Find(databaseValues.InstructorID)
    //                                                                 .FullName);
    ...
    //        {
    //            Department duplicateDepartment = _context.Departments
